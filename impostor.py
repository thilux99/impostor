...
if "jugadores" not in st.session_state:
    ...
    st.session_state.nombre = ""         # para limpiar el input sin error
...
# =====================================================
# PANTALLA 1: CONFIGURACIÓN (agregar jugadores)
# =====================================================
if st.session_state.estado == "config":
    ...
    if st.button("➕ Agregar jugador"):
        if nombre:
            ...
            st.session_state.nombre = ""   # ✅ limpiar input (ahora sí permitido)
    ...
    if len(st.session_state.jugadores) >= 3:
        if st.button("🎮 Iniciar juego"):
            ...
            st.session_state.indice = 0
            st.session_state.mostrar_rol = False
            st.rerun()   # 🔥 “limpia pantalla” cambiando de vista

# =====================================================
# PANTALLA 2: ROLES (uno por uno)
# =====================================================
    ...
    if not st.session_state.mostrar_rol:
        ...
        if st.button("➡️ Siguiente jugador"):
            ...
            st.rerun()   # 🔥 “limpia pantalla” para el siguiente jugador
