...
palabras = [
    ...
    "manzana", "platano", "naranja", "uva", "mango",
    "mesa", "silla", "puerta", "ventana", "lampara",
    "escuela", "hospital", "mercado", "playa",
    "python", "internet", "teclado", "pantalla",
...
if st.session_state.estado == "config":
    ...
    nombre = st.text_input("Nombre del jugador", key="nombre")
